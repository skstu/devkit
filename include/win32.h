...
public:
  ...
  virtual void GeneratePathKey(const char *, const size_t &, char **,
                               size_t *) const = 0;
  virtual void GeneratePathKey(const wchar_t *, const size_t &, wchar_t **,
                               size_t *) const = 0;
  //!@ Hwnd
  virtual void EnumWindows(IWindowInfoArray **) const = 0;
  virtual void EnumChildWindows(const void *hProcessWnd,
                                IWindowInfoArray **) const = 0;
  virtual void EnumProcessWindows(const unsigned long &ProcessId,
                                  IWindowInfoArray **) const = 0;
  //!@ Conv
  virtual bool WStringToUTF8(const wchar_t *, const size_t &, char **,
                             size_t *) const = 0;
  virtual bool WStringToMBytes(const wchar_t *, const size_t &, char **,
                               size_t *) const = 0;
  virtual bool MBytesToWString(const char *, const size_t &, wchar_t **,
                               size_t *) const = 0;
  virtual bool UTF8ToWString(const char *, const size_t &, wchar_t **,
                             size_t *) const = 0;
  virtual bool UTF8ToMBytes(const char *, const size_t &, char **,
                            size_t *) const = 0;
  virtual bool MBytesToUTF8(const char *, const size_t &, char **,
                            size_t *) const = 0;
  //!@ Process
  virtual bool
  ProcessCreate(const char *exePathname, const char *startParamenters,
                unsigned long *pid,
  ...
  virtual void HASH_SHA1(const char *, const size_t &, char **,
                         size_t *) const = 0;
  virtual void HASH_SHA256(const char *, const size_t &, char **,
                           size_t *) const = 0;
  virtual void WemadeEncode(const char *, const size_t &, char **,
                            size_t *) const = 0;
  virtual void WemadeDecode(const char *, const size_t &, char **,
                            size_t *) const = 0;
  virtual void Base64Encode(const char *, const size_t &, char **,
                            size_t *) const = 0;
  virtual void Base64Decode(const char *, const size_t &, char **,
                            size_t *) const = 0;
  //!@ Folder
  virtual bool CreateFolder(const char *path) const = 0;
  virtual IDirectoryArray *EnumFolder(const char *path,
                                      const bool &recursion) const = 0;
};
