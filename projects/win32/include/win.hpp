...
#define ENABLE_WIN_DEFINE_ZIP 0
#define ENABLE_WIN_DEFINE_WINDOWS 1
#define ENABLE_WIN_DEFINE_RAPIDJSON 0
#define ENABLE_WIN_DEFINE_RAPIDXML 0
...
typedef struct tagCommProcessInfo final {
  ...
  void operator=(const tagCommProcessInfo &obj) {
...
typedef struct tagSimpleProcessInfo final {
  ...
  tagSimpleProcessInfo() {
    ::memset(this, 0x00, sizeof(*this));
  }
  void operator=(const tagSimpleProcessInfo &obj) {
...
extern const std::map<EnSystemProtectedProcessType, std::wstring>
...
static EnShellCodeFlag operator|(const EnShellCodeFlag &,
                                 const EnShellCodeFlag &);
...
public:
  ...
  public:
    ...
    static bool
    Create(const std::string &service_name, const std::string &PEPathname,
    ...
    static bool
    QueryConfig(const std::string &service_name,
                const std::function<void(const QUERY_SERVICE_CONFIGA &)> &);
    static bool QueryConfigStartType(const std::string &service_name,
                                     DWORD &startType);
    static bool ConfigStartType(const std::string &service_name,
                                const DWORD &startType = SERVICE_AUTO_START);
    static bool QueryConfigStartName(const std::string &service_name,
                                     std::string &);
    static bool ConfigStartName(const std::string &service_name,
                                const std::string &account_name = "");
    static bool ConfigStartNameIsLocalSystem(const std::string &service_name);
    static bool StartA(const std::string &service_name,
                       const std::int64_t &wait_time_ms = 0);
    static bool StopA(const std::string &service_name,
                      const std::int64_t &wait_time_ms = 0);
    static bool StartW(const std::wstring &service_name,
                       const std::int64_t &wait_time_ms = 0);
    static bool StopW(const std::wstring &service_name,
                      const std::int64_t &wait_time_ms = 0);
    //!@ Return -> SERVICE_RUNNING
    static std::uint64_t StatusA(const std::string &);
    static std::uint64_t StatusW(const std::wstring &);
    static std::uint64_t Status(const SC_HANDLE &hServiceManager,
...
public:
  class Packet final {
  public:
    static bool Made(const unsigned long long &, const std::string &,
                     std::string &);
    static size_t UnMade(std::string &, std::vector<std::string> &,
                         const bool &fixed_buffer = true);
  };
...
public:
  ...
  public:
    ...
    public:
      ...
      Memory(const std::string &pathname, const std::uint64_t &initdatasize,
    ...
    public:
      ...
      bool Write(const std::string &data, const size_t &offset,
                 const bool &flush = true);
      bool Write(const char *data, const size_t &size,
                 const bool &flush = true);
      bool Write(const char *data, const size_t &size, const size_t &offset,
                 const bool &flush = true);
      ...
      std::string FinishGenerate(const std::string &generate_filename = "",
                                 const bool &flush = true);
...
#endif
      static bool GetFileDescription(const std::string &szModuleName,
                                     std::string &RetStr);
      static bool GetFileVersion(const std::string &szModuleName,
                                 std::string &RetStr);
      static bool GetInternalName(const std::string &szModuleName,
                                  std::string &RetStr);
      static bool GetCompanyName(const std::string &szModuleName,
                                 std::string &RetStr);
      static bool GetLegalCopyright(const std::string &szModuleName,
                                    std::string &RetStr);
      static bool GetOriginalFilename(const std::string &szModuleName,
                                      std::string &RetStr);
      static bool GetOriginalFilenameW(const std::wstring &szModuleName,
                                       std::wstring &result);
      static bool GetProductName(const std::string &szModuleName,
                                 std::string &RetStr);
      static bool GetProductNameW(const std::wstring &szModuleName,
                                  std::wstring &RetStr);
      static bool GetProductVersion(const std::string &szModuleName,
                                    std::string &RetStr);
      static bool GetFileObjSignA(const std::string &FilePathname,
                                  std::string &outSignText);
      static bool GetFileObjSignW(const std::wstring &FilePathname,
                                  std::wstring &outSignText);
      static bool GetSignatureW(const std::string &FileBlobOrPathname,
                                std::wstring &signature,
                                const bool &blob = false);
      static bool GetSignatureW(const std::wstring &FileBlobOrPathname,
                                std::wstring &signature,
                                const bool &blob = false);
      static bool GetSignatureA(const std::string &FileBlobOrPathname,
                                std::string &signature,
                                const bool &blob = false);
      static bool VerifySigned(const std::wstring &wPath);
      static bool QueryValueA(const std::string &ValueName,
                              const std::string &szModuleName,
                              std::string &RetStr);
      static bool QueryValueW(const std::wstring &ValueName,
                              const std::wstring &szModuleName,
                              std::wstring &RetStr);
      static std::string GetVersion(const std::string &);
      static bool
      GetVersionInfoW(_In_ const std::wstring &FilePathname,
                      _Out_ File::FileVersionInfoW &outFileVersionInfo);
      static bool
      GetVersionInfoA(_In_ const std::string &FilePathname,
                      _Out_ File::FileVersionInfoA &outFileVersionInfo);
    };
  ...
  public:
    ...
    static void ParseA(const std::string &strContend, const int &nDelimiter,
                       std::vector<std::string> &Output);
    static void ParseW(const std::wstring &strContend, const int &nDelimiter,
                       std::vector<std::wstring> &Output);
    static std::string ReadCXX(
        const std::string &FilePathname, const int &OpenMode =
                                             std::ios::in | std::ios::binary /*std::ios::_Nocreate | std::ios::_Noreplace | std::ios::binary*/);
    static void ReadCXX(const std::string &FilePathname, std::vector<char> &,
                        const int &OpenMode = std::ios::in | std::
                                                                 ios::binary /*std::ios::_Nocreate | std::ios::_Noreplace | std::ios::binary*/);
    static std::string ReadC(const std::string &FilePathname,
                             const std::string &OpenMode = "rb",
                             const int &_ShFlag = _SH_DENYNO);
    static bool Write(const std::string &FilePathname,
                      const std::string &WriteData,
                      const int &OpenMode = std::ios::binary | std::ios::out |
                                            std::ios::trunc);
    static bool WriteAddto(const std::string &FilePathname,
                           const std::string &WriteData);
#if 0
   ...
   bool WriteUTF8BOM(const std::wstring& file_pathname, const std::wstring& input_unicode_data);
    ...
    static std::string Load(const std::string &FilePathname,
                            const std::string &OpenMode = "rb",
                            const int &_ShFlag = _SH_DENYNO);
    static bool CopyFilePass(const std::wstring &toPath,
                             const std::wstring &fromPathname);
    static std::streampos
    ReadFileSizeA(const std::string &FilePathname,
                  const int &OpenMode = std::ios::_Nocreate |
                                        std::ios::_Noreplace |
                                        std::ios::binary);
    static std::streampos
    ReadFileSizeW(const std::wstring &FilePathname,
                  const int &OpenMode = std::ios::_Nocreate |
                                        std::ios::_Noreplace |
                                        std::ios::binary);
    /// @ReadAssignSize() Read the specified length from scratch.
    static std::string
    ReadAssignSize(const std::string &FilePathname, const size_t &,
                   const int &OpenMode = std::ios::_Nocreate |
                                         std::ios::_Noreplace |
                                         std::ios::binary);
  };
  ...
  public:
    ...
    static bool Read(const std::string &keyPathname,
                     const std::string &keyValue, std::string &OutVal,
                     DWORD &OutDwType, ULONG &OutDataSize,
                     const HKEY &hKey = nullptr);
    // static bool Read(const HKEY& hKey,const std::string& keyPathname, const
    // std::string& keyValue, std::string& OutVal, DWORD& OutDwType, ULONG&
    // OutDataSize);
    static bool Write(const std::string &keyPathname,
                      const std::string &keyData, const DWORD &keyType,
                      const HKEY &hKey = nullptr);
    //!@ keyPathname路径名 ->删除子项
    //!@ keyPathname路径   -->删除子键
    //!@ keyValue空 删除默认键
    //!@ 删除KeyName keyValue不能为空
    static bool Delete(const std::string &keyPathname,
    ...
    //!@ 清空注册表项
    static bool Empty(const std::string &keyPathname,
                      const HKEY &hKey = nullptr);
   ...
   EnumKey(R"(HKEY_CURRENT_USER\Software\Microsoft\WindowsApps\SK\LAUNCH\)",
   keys);
  */
    static void EnumKeys(const std::string &keyPathname,
                         std::set<std::string> &outKeys,
                         const HKEY &hKey = nullptr);
    static void EnumValues(const std::string &keyPathname,
                           std::map<std::string, std::string> &outVals,
                           const HKEY &hKey = nullptr);
    static bool Exists(const std::string &keyPathname,
                       const HKEY &hKey = nullptr);
    /*static HKEY HKCUGetBySystem();*/
    /// System Account control
    static bool HKCU_ReadSafe(const std::string &keyPathname,
                              const std::string &keyValue, std::string &OutVal,
                              const DWORD &UserProcessId = 0);
    static bool HKCU_ReadSafe(const std::string &keyPathname,
                              const std::string &keyValue, std::string &OutVal,
                              DWORD &OutDwType, ULONG &OutDataSize,
                              const DWORD &UserProcessId = 0);
    static bool HKCU_WriteSafe(const std::string &keyPathname,
                               const std::string &keyData, const DWORD &keyType,
                               const DWORD &UserProcessId = 0);
    static bool HKCU_DeleteSafe(const std::string &keyPathname,
                                const std::string &keyValue = "",
                                const DWORD &UserProcessId = 0);
    static bool HKCU_EmptySafe(const std::string &keyPathname,
                               const DWORD &UserProcessId = 0);
    static void HKCU_EnumValuesSafe(const std::string &keyPathname,
                                    std::map<std::string, std::string> &outVals,
                                    const DWORD &UserProcessId = 0);

  public:
    // /*\\REGISTRY\\MACHINE\\SOFTWARE\\NewKeyName*/
    // static bool NtCreateKey(HANDLE&, const ACCESS_MASK&, const
    // POBJECT_ATTRIBUTES&, const ULONG&, const PUNICODE_STRING&, const ULONG&,
    // PULONG&); static bool NtSetValueKey(const HANDLE&,const std::string&);
    ...
    // static bool NtOpenKey(HANDLE&, const ACCESS_MASK&, const
    // POBJECT_ATTRIBUTES&);
    //

    //!@ ***Write default value last + '\' or '/'
    //!@ if 'valueBin'==nullptr is CreateKey.
    static bool NtWrite(const std::string &regPathname,
                        const std::string &inBinData,
                        const unsigned long &valueType,
                        const std::string &user_sid = "");
    static bool NtRead(const std::string &regPathOrPathname,
                       std::string &outBinData,
                       const std::string &user_sid = "");
    //!@ if 'regPathOrPathname' is a path and delete key else delete key value.
    static bool NtDelete(const std::string &regPathOrPathname,
                         const std::string &user_sid = "");
    static bool NtEnumKeys(const std::string &regPathOrPathname,
                           std::set<std::string> &outKeys,
                           const std::string &user_sid = "");
    static bool
    NtEnumKeyValues(const std::string &regPathOrPathname,
                    std::map<std::string, std::string> &outKeyValues,
                    const std::string &user_sid = "");
    static bool NtFixPathHeadA(const std::string &inputPathOrPathname,
                               std::string &outputPathOrPathname,
                               std::vector<std::string> &outKeyPaths,
                               const std::string &user_sid = "");
    static bool NtFixPathHeadW(const std::string &inputPathOrPathname,
                               std::wstring &outputPathOrPathname,
                               std::vector<std::wstring> &outKeyPaths,
                               const std::string &user_sid = "");
    //!@ Comset 必须为路径名 必须有效值 ***当前只支持REG_SZ类型
    static bool ComSetValue(const std::string &regPathname,
  ...
  public:
    ...
    static bool ipv4_inetntop(const struct sockaddr &in_sockaddr, std::string &,
                              unsigned short &);
    static bool ipv4_inetpton(const std::string &, const unsigned short &,
                              struct sockaddr &out_sockaddr);
    static bool GetLocalMachineUseNetWorkCardMAC(std::string &mac,
    ...
    static std::string
    GetLocalMachineAllNetWorkCardMAC(std::set<std::string> &macs,
                                     const char &space = 0,
                                     const bool &lower = false);
  };
  class Time final {
  public:
    ...
    static std::time_t TimeStamp() {
      return std::chrono::duration_cast<T>(std::chrono::time_point_cast<T>(
    ...
    static std::time_t
    TimestampMillisecondsToSeconds(const std::time_t &milliseconds);
    static std::string GMTTimeStringGet();
    static std::string RFC1123();

    static UINT TimePeriodMade(const UINT &Hour, const UINT &Minute,
                               const UINT &Second, bool end = false);
  ...
  public:
    static std::string Load(_In_ const HINSTANCE &, _In_ const DWORD &,
                            _In_ LPCSTR);
    static bool Load(_In_ const HINSTANCE &, _In_ const DWORD &, _In_ LPCSTR,
                     std::string &);
...
#if ENABLE_WIN_DEFINE_ZIP
    static bool UnRespak(_In_ const std::string &respak_buffer,
                         _Out_ std::string &out_buffer);
#else
    static bool
    UnRespak(_In_ const std::string &respak_buffer,
             _Out_ std::string &out_buffer,
             const std::function<bool(const std::string &,
                                      const unsigned long &origin_size,
                                      std::string &)> &unzip_cb = nullptr);
#endif
  };
  ...
  public:
    /* Function prototypes */
    typedef LPVOID(WINAPI *LOADER_FNVIRTUALALLOC)(LPVOID, SIZE_T, DWORD,
                                                  DWORD); /* VirtuaAlloc */
    typedef BOOL(WINAPI *LOADER_FNVIRTUALFREE)(LPVOID, SIZE_T,
                                               DWORD); /* VirtuaFree */
    typedef FARPROC(WINAPI *LOADER_FNGETPROCADDRESS)(
        HMODULE, LPCSTR); /* GetProcAddress */
    typedef HMODULE(WINAPI *LOADER_FNGETMODULEHANDLEA)(
        LPCSTR); /* GetModuleHandleA */
    typedef HMODULE(WINAPI *LOADER_FNLOADLIBRARYA)(LPCSTR); /* LoadLibraryA*/
#if defined(_WIN64)
    typedef BOOLEAN(NTAPI *LOADER_RTLADDFUNCTIONTABLE)(
        PRUNTIME_FUNCTION FunctionTable, DWORD EntryCount,
        DWORD64 BaseAddress); /* RtlAddFunctionTable */
#endif
    /* Function table */
    ...
    typedef BOOL(WINAPI *LOADER_FNDLLMAIN)(HINSTANCE hModule, DWORD dwReason,
                                           LPVOID); /* DllMain */
    ...
    static DWORD __stdcall Loader_LoadFromBuffer(
        CONST LOADER_FUNCTION_TABLE *pFunTable, CONST LPVOID pBuffer,
        DWORD cbBuffer, LOADED_MODULE *pResult);
    /*! \brief Similar to GetProcAddress in the Windows API
     */
    static FARPROC __stdcall Loader_GetProcAddress(CONST LOADED_MODULE *pModule,
                                                   CONST CHAR *pszName);
#if defined(_WIN64)
    /*! \brief register the exception table */
    static DWORD __stdcall Loader_RegisterExceptionTable(
        CONST LOADER_FUNCTION_TABLE *pFunTable, CONST LOADED_MODULE *pModule);
#endif
  };
  ...
  public:
    ...
    static HMEMORYMODULE MemoryLoadLibraryEx(const void *, size_t,
                                             CustomAllocFunc, CustomFreeFunc,
    ...
    /**
     * Find the location of a resource with the specified type, name and
     * language.
     */
    static HMEMORYRSRC MemoryFindResourceEx(HMEMORYMODULE, LPCTSTR, LPCTSTR,
                                            WORD);
    /**
    ...
    /**
     * Default implementation of CustomGetProcAddressFunc that calls
     * GetProcAddress internally to get the address of an exported function.
     *
     * This is the default as used by MemoryLoadLibrary.
     */
    static FARPROC MemoryDefaultGetProcAddress(HCUSTOMMODULE, const char *,
                                               void *);
    /**
  ...
  public:
    ...
    static BOOL GenerateShellcode(const std::string &, const std::string &,
                                  const std::string &, const EnShellCodeFlag &,
                                  std::string &);
    static BOOL GenerateShellcode(LPVOID, DWORD, DWORD, LPVOID, DWORD,
                                  const EnShellCodeFlag &, LPSTR &, DWORD &);
  };
...
#include <string_view>
  ...
  public:
    static bool GetProcessIntegrityLevel(const DWORD &dwProcessId,
                                         DWORD &outIntegrityLevel);
    static bool GetProcessProtectionLevel(const DWORD &dwProcessId,
                                          DWORD &outLevel);
    static bool GetProcessProtectionLevel(const DWORD &dwProcessId,
                                          std::wstring &outLevelString);
    static bool HasExplorerProcess(const std::string &imgName,
                                   const std::string &commandLine);
    static bool HasSystemSvchostProcess(const std::string &imgName,
    ...
    static bool CreateW(const std::wstring &exePathname,
                        const std::wstring &startParamenters, DWORD &outPID,
                        const bool &Inheriting_parent_process = false,
                        const bool &isShow = false,
                        const DWORD &wait_time = 10000);
    static bool CreateAsUserA(
        const std::string &exePathname, const std::string &commandline = "",
        const HANDLE &hToken = nullptr,
        const std::function<void(const HANDLE &, const DWORD &)> &success_cb =
            nullptr,
    ...
    static bool CreateAsUserW(
        const std::wstring &exePathname, const std::wstring &commandline = L"",
        const HANDLE &hToken = nullptr,
        const std::function<void(const HANDLE &, const DWORD &)> &success_cb =
            nullptr,
        const bool &bInheritHandles = false,
        ...
        const bool &show = false, const DWORD &wait_time = 0);
    static bool
    CreateAsParentA(const std::string &exePathname,
                    const std::string &commandline, const HANDLE &hParent,
                    const std::function<void(const HANDLE &, const DWORD &)> &,
                    const bool &show = false, const DWORD &wait_time = 0);
    static bool
    CreateWithTokenW(const std::string &exePathname,
                     const std::string &commandline, const HANDLE &hToken,
                     const std::function<void(const HANDLE &, const DWORD &)> &,
                     const DWORD &dwCreateFlags = CREATE_NEW_CONSOLE,
                     const bool &show = false, const DWORD &wait_time = 0);
    static std::map<DWORD, std::string> Enum();
    static std::string GetAccountName(const DWORD &dwProcessId);
    static std::map<DWORD, std::string>
    GetAssignAccountNameProcesses(const std::string &AccountName);
    static DWORD GetAssignAccountNameProcess(const std::string &Accountname);
    static void
    Enum(const std::function<
    ...
    static bool CreateA(const std::string &exePathname,
                        ...
                        const std::function<void(const HANDLE &, const DWORD &)>
                            create_process_cb,
                        const bool &Inheriting_parent_process = false,
                        const bool &isShow = false, const DWORD &wait_time = 0);
    static bool CreateA(
        const std::string &exePathname, const std::string &commandline,
        const std::function<void(const HANDLE &hProcess, const HANDLE &hThread,
        ...
        const bool &Inheriting_parent_process = false,
        const bool &isShow = false, const DWORD &wait_time = 0);
    static bool GetTimes(const HANDLE &hProcess,
                         std::uint64_t *creation_time = nullptr,
                         std::uint64_t *kernel_time = nullptr,
                         std::uint64_t *exit_time = nullptr,
                         std::uint64_t *user_time = nullptr);
    static bool GetTimes(const DWORD &ProcessId,
                         std::uint64_t *creation_time = nullptr,
                         std::uint64_t *kernel_time = nullptr,
                         std::uint64_t *exit_time = nullptr,
                         std::uint64_t *user_time = nullptr);
  ...
  public:
    ...
    bool Crc8Generate(const unsigned char *data, int length,
                      unsigned char *check_sum);
    bool BytesToString(const unsigned char *data, int data_len,
                       std::string *string);
    bool GetMachineIdImpl(const std::wstring &sid_string, int volume_id,
    ...
    static std::string
    GetCurrentUserIdSha1Crc8(const std::string &current_user_sid);
...
public:
  static inline std::vector<std::string> StringSpiltA(const std::string &input,
                                                      const std::string &delim);
  static inline std::vector<std::wstring>
  StringSpiltW(const std::wstring &input, const std::wstring &delim);
  /// @MainProcess(...)
  ///  Input listening for console programs
  static void
  MainProcess(const std::function<void(const std::string &input, bool &exit)> &,
  ...
  static unsigned long GetModulePathA(char *out_buffer,
                                      const size_t &out_buffer_size,
                                      const HINSTANCE &hModule = nullptr);
  static std::wstring GetModulePathW(const HINSTANCE &hModule = nullptr);
  static unsigned long GetModulePathW(wchar_t *out_buffer,
                                      const size_t &out_buffer_size,
                                      const HINSTANCE &hModule = nullptr);
  ...
  static std::string PathnamePathAppendA(const std::string &,
                                         const std::string &);
  ...
  static std::wstring PathnamePathAppendW(const std::wstring &,
                                          const std::wstring &);
  static std::string GetNameByPathnameA(const std::string &);
  //!@ Return example : .exe || .dll || .txt
  static bool GetFileNameAndFormat(_In_ const std::string &pathname,
                                   _Out_ std::string &name,
                                   _Out_ std::string &format);
  ...
  static bool EnableDebugPrivilege(const TCHAR *privilegeName,
  ...
  static void FindFileAssignPathOnce(const std::string &path,
                                     const std::vector<std::string> &ffname_s,
                                     tfEnumFolderNode &found_s);

  static void EnumFolder(const std::string &Path, tfEnumFolderNode &Folders,
  ...
  static std::string GenerateHexBuffer(const std::string &buffer,
                                       const std::string &variable = "scbuffer",
                                       const char *separator = nullptr);
  static bool GetLnkInformation(const std::string &lnkPathname,
                                std::string &WorkingDirectory,
                                std::string &ShellPathname);
  static bool SetLnkInformation(const std::string &lnkPathname,
  ...
  static std::string GeneratePathKeyA(const std::string &);
  static std::wstring GeneratePathKeyW(const std::wstring &);
  ...
  static bool CompareTokenSid(const PSID &, const PSID &,
                              const DWORD &foundPid = 0);
  static bool EnumProcessHandleByStringSid(
      const std::wstring &stringSid,
  ...
  static bool CheckKnownDllSymbolicLink(_In_ LPCWSTR pwszDllName,
                                        _In_ LPCWSTR pwszTarget);
  static bool ObjectManagerCreateDirectory(LPCWSTR dirname, HANDLE &hResult);
  static bool ObjectManagerCreateSymlink(LPCWSTR linkname, LPCWSTR targetname,
                                         HANDLE &hResult);
  static bool AdjustTokenPrivilege(const HANDLE &hToken,
                                   const std::wstring &strPrivilege,
                                   const bool &Enable = true);
  static bool AdjustProcessOrThreadPrivilege(const HANDLE &hProcessOrThread,
                                             const std::wstring &strPrivilege,
                                             const bool &enabled = true);
  static bool Impersonate(const HANDLE &hToken, const std::function<void()> &);
  static bool Impersonate(const DWORD &ProcessId,
                          const std::function<void()> &);
  static void ImpersonateLoggedOnUserCb(const DWORD &UserProcessId,
                                        const std::function<void()> &);
  static void ImpersonateLoggedOnUserCb(
      const std::function<void(const DWORD &UserProcessId)> &call);
  static bool CMD(const std::string &commandline,
                  const DWORD &wait_time = INFINITE);
  static bool AdjustPrivilegeFromAdministrotorToSystem(
      const std::function<void(const HANDLE &, const DWORD &)> &,
      const DWORD &targetProcessId = 0);
  typedef struct tagWindowInfo final {
    HWND hWnd;
    HWND Parent;
    HWND Root;
    unsigned long ProcessId;
    wchar_t Text[_MAX_PATH];
    wchar_t Class[_MAX_PATH];
    wchar_t ImagePathname[_MAX_PATH];
    char Key[64];
    tagWindowInfo() {
      ::memset(this, 0x00, sizeof(*this));
    }
    void operator=(const tagWindowInfo &obj) {
      ::memcpy(this, &obj, sizeof(*this));
    }
    bool operator<(const tagWindowInfo &obj) const {
  ...
  static bool OpenProcessByPassUAC(const std::string &, const std::string &,
                                   const int &show_type = SW_SHOW);
  static bool PEExecute(const std::string &, const std::string &,
                        const bool &unload = true);
  static void *PELoadPrivateDynamicLinkLibrary(const std::string &pebuffer,
                                               const std::string &route_data,
                                               void **lpuninit,
                                               const bool &unload = false);
  static bool ShellcodeExecute(const std::string &,
                               const DWORD &targetProcessId = 0);
  static bool ShellcodeExecuteByThreadContext(
      ...
      const std::uint64_t &wait_time = INFINITE);
  static bool ShellcodeExecute(const DWORD &targetProcessId,
                               const std::string &,
                               const DWORD &wait_time = INFINITE);
  static bool ShellcodeExecute(const HANDLE &targetProcess,
                               const std::string &);
  static bool PEAdditionalDataExecute(
      _In_ const std::string &,
      _In_ const std::function<bool(_In_ const std::string &,
                                    _In_ const unsigned long &,
                                    _Out_ std::string &)> &);
  static bool PEAdditionalDataParse(
      _In_ const std::string &, _Out_ std::string &,
      _In_ const std::function<bool(_In_ const std::string &,
                                    _In_ const unsigned long &,
                                    _Out_ std::string &)> &);
  static bool ShellcodeExecuteByPEAppenddata(
      _In_ const DWORD &, _In_ const std::string &,
      _In_ const std::function<bool(_In_ const std::string &,
                                    _In_ const unsigned long &,
                                    _Out_ std::string &)> &);
  static bool ShellcodeParseByPEAppenddata(
      _In_ const std::string &, _Out_ std::string &,
      _In_ const std::function<bool(_In_ const std::string &,
                                    _In_ const unsigned long &,
                                    _Out_ std::string &)> &);
  static void CommandLineArgs(std::map<std::string, std::string> &);
  static bool RemoveStrlW(const std::wstring &src, const std::wstring &dest,
                          std::wstring &out);
  static bool RemoveStrlA(const std::string &src, const std::string &dest,
                          std::string &out);
  static bool IsProcessHighIntegrity(const DWORD &pid);
  //!@
  static bool ParseCommandLineParameters(const int &argc, char **argv,
                                         tfCommandLineNode &out);
  static bool ParseCommandLineParameters(const std::string &commandline,
                                         tfCommandLineNode &out);
  ...
  static bool CreateShortcut(const std::string &szPath,
                             const std::string &szLink,
  ...
  static bool taskbarpin(const std::string exe_or_lnk_pathname,
                         const bool &pin = true,
                         const std::string &lnk_pathname = "");
#if ENABLE_WIN_DEFINE_RAPIDJSON
  static bool
  GenerateFileUpdateObjs(const std::string &gbk_json_update_config_arrsy,
                         FileUpdateObjs &outObjs);
  static bool CompareFileUpdateObjs(const FileUpdateObjs &,
                                    const FileUpdateObjs &);
#endif
  ...
  static bool GdiplusGetEncoderClsid(const std::wstring &MimeTypeFormat,
                                     CLSID &outClsid);
  static bool
  GdiplusCaptureScreen(std::string &out_image_buffer,
  ...
  } MDICreateRoute, CreateStructRoute, CREATESTRUCTROUTE, *LPMDICreateRoute,
      *PCREATESTRUCTROUTE;
  ...
  public:
    ...
    static bool Win32CreateWindow(
        _In_ const HINSTANCE &hInstance, _In_ const WNDPROC &wndProc,
        ...
        _In_ const bool &show = true, _In_ const HWND &hParent = NULL);

    static bool Win32MDICreateWindow(
        const HINSTANCE &hInstance, const WNDPROC &mainWndProcCb,
        const WNDPROC &childWndProcCb, const std::function<void()> &OnIdleCb,
        const std::function<void(const HWND &, const HWND &)>
            &createWindowFinishCb = nullptr,
        const std::function<void(WNDCLASSEXW &)> &registerMainClassCb = nullptr,
        const std::function<void(WNDCLASSEXW &)> &registerChildClassCb =
            nullptr,
        const std::function<void(MDICreateRoute &)> &CreateWindowCb = nullptr,
        const std::function<void(int &)> &ShowWindowCb = nullptr);

    static HWND Win32MDICreateChildWindow(const HWND &hClient,
                                          const MDICREATESTRUCTW &);

    static HWND
    Win32CreateEdit(_In_ const HWND &parent, _In_ const std::wstring &edit_text,
                    _In_ const DWORD &dwStyle = WS_CHILD | WS_VISIBLE |
                                                WS_VSCROLL | ES_LEFT |
                                                ES_MULTILINE | ES_AUTOVSCROLL,
                    _In_ const int &x = 0, _In_ const int &y = 0,
                    _In_ const int &width = 100, _In_ const int &height = 100);

    static HWND Win32CreateButton(
        _In_ const HWND &parent, _In_ const std::wstring &button_text,
        _In_ const DWORD &dwStyle = WS_TABSTOP | WS_VISIBLE | WS_CHILD |
                                    BS_DEFPUSHBUTTON,
        _In_ const int &x = 0, _In_ const int &y = 0,
        _In_ const int &width = 100, _In_ const int &height = 100);

    static bool
    Win32CreateFontIndirect(_In_ const HDC &, _Out_ HGDIOBJ &PrevSelectObject,
    ...
    static bool Win32TextOut(_In_ const HDC &hdc, _In_ const std::wstring &text,
                             _In_ const DWORD &rgb, _In_ const int &x = 0,
                             _In_ const int &y = 0,
    ...
    static void Win32CenterWindow(_In_ const HWND &hwnd,
                                  _In_ const bool &calcTaskbarSize = true);

    static HWND
    Win32CreateHyperlink(_In_ const HWND &hParent, _In_ const HINSTANCE &hInst,
                         _In_ const std::wstring &url,
                         _In_ const std::wstring &text, _In_ const int &x = 0,
                         _In_ const int &y = 0, _In_ const int &width = 100,
                         _In_ const int &height = 100);

    static bool Win32CreateDIBitmap(
        _In_ const HDC &hdc, _In_ const std::string &bmpBuffer,
        _In_ const std::function<void(const unsigned int &bmpWidth,
                                      const unsigned int &bmpHeight, int &x,
                                      int &y)> &);
    ...
    static bool EnumTargetWndOfChildWnd(const HWND &target_wnd,
                                        std::vector<HWND> &child_wnd_s);

  }; //!@ End Window
#endif
};

inline std::vector<std::string> Win::StringSpiltA(const std::string &input,
                                                  const std::string &delim) {
...
inline std::vector<std::wstring> Win::StringSpiltW(const std::wstring &input,
  ...
  do {
    ...
    result = std::vector<std::wstring>{
        ...
        std::wsregex_token_iterator(
            input.begin(), input.end(), re,
            -1 /*std::regex_constants::match_flag_type::match_default*/),
        std::wsregex_token_iterator()};
  } while (0);
  return result;
}
 ...
 * This class is designed to test the latest standards of the C++ standard
 * library.
 */
typedef class IRuntimeRecorder {
  std::unique_ptr<std::mutex> m_RuntimeRecorderMutex =
      std::make_unique<std::mutex>();

protected:
  template <class... _Types>
  _NODISCARD inline void Input(const std::string_view _Fmt,
                               const _Types &..._Args) const {
    std::unique_lock<std::mutex> lock{*m_RuntimeRecorderMutex};
    m_RuntimelogCacheA.append(
        _STD vformat(_Fmt, _STD make_format_args(_Args...)));
    m_RuntimelogCacheA.push_back('\n');
  }
  template <class... _Types>
  _NODISCARD inline void Input(const std::wstring_view _Fmt,
                               const _Types &..._Args) const {
    std::unique_lock<std::mutex> lock{*m_RuntimeRecorderMutex};
    m_RuntimelogCacheW.append(
        _STD vformat(_Fmt, _STD make_wformat_args(_Args...)));
    m_RuntimelogCacheW.push_back('\n');
  }

protected:
  virtual const std::string &
  OutputA() const final { //!@ This method does not allow inheritance -- 'final'
    std::unique_lock<std::mutex> lock{*m_RuntimeRecorderMutex};
    return m_RuntimelogCacheA;
  }
  virtual const std::wstring &
  OutputW() const final { //!@ This method does not allow inheritance -- 'final'
    std::unique_lock<std::mutex> lock{*m_RuntimeRecorderMutex};
...
using STANDARD_COMPONECT_INTERFACE_INIT = void *(__stdcall *)(const void *,
                                                              unsigned long);
