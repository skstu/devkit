      ...
      return (
        ...
        s(function (e) {
          return a(e.navigator, {
            appCodeName: t.fps.navigator.appCodeName,
            appName: t.fps.navigator.appName,
            appVersion: t.fps.navigator.appVersion,
            userAgent: t.fps.navigator.userAgent,
            platform: t.fps.navigator.platform,
            language: t.fps.navigator.language,
            languages: t.fps.navigator.languages,
            hardwareConcurrency: t.fps.navigator.hardwareConcurrency,
          });
        }),
        s(function (e) {
