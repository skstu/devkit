...
void SKFps::Init() {
  skfps_js_script_part_screen__configure_ = R"(
    return a(e, {
    screen: {
    availLeft: 0,
    availTop: 0,
  ...
  inject_configure_ = "";
  inject_js_code_template_ = skfps_js_injector_code_template;
}
void SKFps::UnInit() {
}

void SKFps::SetConfigure(const std::string &config) {
  inject_configure_ = config;
}

const char skfps_js_injector_code_template[] = R"(
(function (e) {
  var t = JSON.parse(e);
  var n = t.g;
  var r = t.g.substr(1);
...
const char skfps_js_injector_code_template_bak[] = R"(
(function (e) {
  var t = JSON.parse(e);
  var n = t.g;
  var r = t.g.substr(1);
