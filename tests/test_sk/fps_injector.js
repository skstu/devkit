(function (e) {
    ...
    var s = function (e) {
      ...
      return (
        ...
        s(function (e) {
          return a(e, {
            screen: {
              availLeft: t.fps.screen.availLeft,
              availTop: t.fps.screen.availTop,
              availWidth: t.fps.screen.availWidth,
              availHeight: t.fps.screen.availHeight,
              width: t.fps.screen.width,
              height: t.fps.screen.height,
              colorDepth: t.fps.screen.colorDepth,
              pixelDepth: t.fps.screen.pixelDepth,
        ...
        s(function (e) {
          return a(e.navigator, {
            platform: t.fps.navigator.platform,
            language: t.fps.navigator.language,
            languages: t.fps.navigator.languages,
          });
        }),
        s(function (e) {
  ...
  '{"g":"martell","s":".5568","v":3327,"w":"","b":"fingerprintjs.github.io,pixelscan.net","fps":{"screen":{"availLeft":0,"availTop":0,"availWidth":888,"availHeight":666,"width":777,"height":555,"colorDepth":16,"pixelDepth":16},"navigator":{"platform":"Win32","language":"en-US","languages":["en-US"]}}}'
);
